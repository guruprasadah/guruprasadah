...
A toy web framework built with HTMX, WebSockets, Python, and Tailwind.
Focused on simplicity, interactivity, and minimal overhead.

### 🪓 chainsawm

An X11 window manager designed to be as sharp and minimal as possible.
Explores low-level control, performance, and ergonomics.
